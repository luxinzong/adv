...
public class AdvFlywordServiceImpl extends BaseServiceImpl<AdvFlyWord, AdvFlyWordExample, Long> implements AdvFlywordService {
    ...
    @Override
    public List<AdvFlyWord> findList(List<Long> flywordIds) {
        AdvFlyWordExample advFlyWordExample = new AdvFlyWordExample();
        advFlyWordExample.createCriteria().andIdIn(flywordIds);
        return advFlyWordMapper.selectByExample(advFlyWordExample);
    }
